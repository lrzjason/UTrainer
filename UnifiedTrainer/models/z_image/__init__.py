"""Z-Image model adapter -text-to-image generation with 4-channel latents."""
...
@ModelRegistry.register("z_image")
class ZImageAdapter(BaseModelAdapter):
    """Adapter for Z-Image text-to-image model."""
    ...
    def load_transformer(self, path: str, dtype: torch.dtype) -> nn.Module:
        ...
        return ZImageTransformer2DModel.from_pretrained(path, torch_dtype=dtype)
